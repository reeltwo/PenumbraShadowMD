...
MARCDUINO_ACTION(FPSINormalSequence, @1P1, ({
  frontPSI.selectSequence(LogicEngineRenderer::PSICOLORWIPE, LogicEngineDefaults::kRed);    
}))
...
MARCDUINO_ACTION(RPSINormalSequence, @2P1, ({
  rearPSI.selectSequence(LogicEngineRenderer::PSICOLORWIPE, LogicEngineDefaults::kYellow);
}))
...
MARCDUINO_ACTION(PSIVerticalScanLineSequence, @0P9, ({
    frontPSI.selectSequence(LogicEngineRenderer::VERTICALSCANLINE);
    rearPSI.selectSequence(LogicEngineRenderer::VERTICALSCANLINE);
}))
