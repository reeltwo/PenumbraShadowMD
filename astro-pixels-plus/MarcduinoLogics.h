...
MARCDUINO_ACTION(VerticalScanLineSequence, @0T9, ({
    FLD.selectSequence(LogicEngineRenderer::VERTICALSCANLINE);
    RLD.selectSequence(LogicEngineRenderer::VERTICALSCANLINE);
}))
