...
#define SABERTOOTH_SERIAL_RX    RXD3_PIN
#define SABERTOOTH_SERIAL_TX    TXD3_PIN

#define MD_SERIAL               Serial1
#define SABERTOOTH_SERIAL       saberToothSerial
...
#define SABERTOOTH_SERIAL_INIT(baud) SABERTOOTH_SERIAL.begin(baud, SWSERIAL_8N1, SABERTOOTH_SERIAL_RX, SABERTOOTH_SERIAL_TX, false)

SoftwareSerial SABERTOOTH_SERIAL;
